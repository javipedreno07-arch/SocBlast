...
const AVATAR_OPTS = {
  top: [
    ...
    {id:'sides',            label:'Rapado lateral'},
    {id:'theCaesar',        label:'Clásico corto'},
    {id:'dreads01',         label:'Dreadlocks'},
    {id:'dreads02',         label:'Dreadlocks 2'},
    {id:'straight01',       label:'Largo liso'},
    {id:'straight02',       label:'Largo liso 2'},
    {id:'curly',            label:'Largo rizado'},
    {id:'curvy',            label:'Ondulado'},
    {id:'frizzle',          label:'Rizado corto'},
    {id:'shaggy',           label:'Despeinado'},
    {id:'shaggyMullet',     label:'Shaggy largo'},
    {id:'longButNotTooLong',label:'Semi-largo'},
    {id:'miaWallace',       label:'Liso corto'},
    {id:'bun',              label:'Moño'},
    {id:'bob',              label:'Bob'},
    {id:'fro',              label:'Afro'},
