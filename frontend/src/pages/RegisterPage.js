...
const RegisterPage = () => {
  ...
  const css = `
    ...
    .input-field{transition:border-color 0.2s,box-shadow 0.2s!important;}
    ...
    .rol-btn{transition:border-color 0.2s,background 0.2s,color 0.2s!important;}
  `;
      ...
      <div style={{ minHeight: '100vh', backgroundColor: BG, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '20px', fontFamily: "'Inter',-apple-system,sans-serif", position: 'relative', overflow: 'hidden' }}>
        ...
        <div className="fade-up" style={{ width: '100%', maxWidth: '420px', position: 'relative' }}>
          ...
          <div style={{ backgroundColor: CARD, border: `1px solid ${BD}`, borderRadius: '16px', padding: '32px', backdropFilter: 'blur(20px)', boxShadow: '0 24px 80px rgba(0,0,0,0.5)', position: 'relative', overflow: 'hidden' }}>
            ...
            {error && (
              <div style={{ marginBottom: '20px', padding: '12px 16px', borderRadius: '10px', backgroundColor: 'rgba(239,68,68,0.06)', border: '1px solid rgba(239,68,68,0.2)', color: '#F87171', fontSize: '13px', lineHeight: 1.5 }}>{error}</div>
            )}
            ...
            <div style={{ marginBottom: '20px' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '8px' }}>
                {[{ id: 'analista', emoji: '🛡️', label: 'Analista SOC', sub: 'Quiero entrenar' }, { id: 'empresa', emoji: '🏢', label: 'Empresa', sub: 'Busco talento' }].map(r => (
